  ...
  constructor() {
    this.validationMessage = {
      title: {
        ...
        maxlength: `Tilte must be ${this.titleMax} characters or less.`
      },
      location: {
      ...
      startDate: {
        ...
        maxlength: `Start date cannot be longer than ${
          this.dateMax
        } characters.`,
        pattern: `Start date must be in the format <strong>${
          this.dateFormat
        }</strong>.`,
      ...
      startTime: {
        ...
        pattern: `Start time must be a <strong>valid time</strong> in the format <strong>${
          this.timeFormat
        }</strong>.`,
      ...
      endDate: {
        ...
        pattern: `End date must be in the format <strong>${
          this.dateFormat
        }</strong>.`,
      ...
      endTime: {
        ...
        pattern: `End time must be a <strong>valid time</strong> in the format <strong>${
          this.timeFormat
        }</strong>.`,
